...
function initMap() {
  // center ที่ตำบลวังยาง อำเภอศรีประจันต์ จังหวัดสุพรรณบุรี
  ...
  L.marker(WANG_YANG_CENTER, { icon: municipalityIcon, interactive: true })
    .bindPopup(`
      <strong>🏛️ เทศบาลตำบลวังยาง</strong><br>
      📍 ตำบลวังยาง อำเภอศรีประจันต์<br>
      จังหวัดสุพรรณบุรี
    `)
    .addTo(incidentMap);
...
function goToLatestIncident() {
  if (!incidentMap) return;
  // กลับไปที่ศูนย์กลางเทศบาลตำบลวังยาง
