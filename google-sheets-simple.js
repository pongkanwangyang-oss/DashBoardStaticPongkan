...
const GOOGLE_SHEETS_CONFIG = {
  SPREADSHEET_ID: '1BYU24ip8Cn58Y4lmtYzoUPpIMchvw4SX-brwahtj1A8',
  SHEET_NAME: 'log1',  // ชื่อ sheet,
  WEB_APP_URL: 'https://script.google.com/macros/s/AKfycbyCAs2WgeC8norIceHHCLYS7F1W625t54MZ8qERNa07zD3tRRgmp6gTxOLOCceTS8Cz/exec'
};

// ฟังก์ชันสำหรับอ่านข้อมูลจาก Google Sheets (CSV Export)
async function loadFromGoogleSheets() {
  try {
    // สร้าง URL สำหรับ CSV export
